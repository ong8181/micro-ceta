...
g2 <- d_all %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
        panel.grid.major = element_line(linewidth = 0.1, color = "gray70")) +
  ylab("N of species matched by the forward primer") + ggtitle("Forward primers: N of species matched")
...
g3 <- d_all %>% 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
        panel.grid.major = element_line(linewidth = 0.1, color = "gray70")) +
  ylab("N of species matched by the reverse primer") + ggtitle("Reverse primers: N of species matched")
...
# ------------------------------------------------ #
# Save figures
ggsave(file = sprintf("%s/nspp_amplified_all.pdf", output_folder),
       plot = gg_obj,
       width = 16, height = 10)
ggsave(file = sprintf("%s/nspp_amplified_all_frPrimers.pdf", output_folder),
