...
output_folder <- "02_DADA2Out/Run3_Out"
dir.create("02_DADA2Out")
dir.create(output_folder)

# Load sequence reads
path <- paste0(getwd(), "/01_QualityFiltering_Run3Out")
system("rm 01_QualityFiltering_Run3Out/unknown*")
...
# Identify primers
FWD <- "CTGACTTCCAATCAGTTRGTTTCGG"
REV <- "CATTCTARRCCYTYTTGRG"
