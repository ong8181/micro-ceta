...
library(tidyverse); packageVersion("tidyverse") # 2.0.0, 2024.6.13
library(phyloseq); packageVersion("phyloseq") # 1.44.0, 2024.6.13
library(cowplot); packageVersion("cowplot") # 1.1.3, 2024.6.13
...
tax_sheet$seq <- tax_seq[,1]
tax_sheet$seqlen <- nchar(tax_seq[,1])
