...
# --------------------------------------------------------------------------------------- #
WORKING_FOLDER="XXXXXX/Cet6_Ceto2"
...
clidentseq --blastdb=overall_genus_cache --minalnlennn=50 --numthreads=36 ${FASTA_FILE} overall_genus_clidentseq
...
clidentseq --blastdb=overall_class_cache --minalnlennn=50 --numthreads=36 ${FASTA_FILE} overall_class_clidentseq
...
# Overall_genus
clmakecachedb --blastdb=overall_genus --numthreads=36 ${FASTA_FILE_ASV} overall_genus_cache_asv
clidentseq --blastdb=overall_genus_cache_asv --minalnlennn=50 --numthreads=36 ${FASTA_FILE_ASV} overall_genus_clidentseq_asv
classigntax --taxdb=overall_genus --maxpopposer=0.10 --minsoratio=9 overall_genus_clidentseq_asv overall_genus_classigntax_asv

# overall_class
clmakecachedb --blastdb=overall_class --numthreads=36 ${FASTA_FILE_ASV} overall_class_cache_asv
clidentseq --blastdb=overall_class_cache_asv --minalnlennn=50 --numthreads=36 ${FASTA_FILE_ASV} overall_class_clidentseq_asv
