...
# ------------------------------------ #
# Identify primers
FWD <- "CACGCACACACCGCCCG"
REV <- "GTATGCTTACCTTGTTACGAC"
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     truncLen=c(60, 60), # Some low quality seuqences are found at the end
...
min_nbases <- 60 * sum(out[,2]) # Use a small number of bases to speed up the analysis
